...
export type ProjectIssuesCount = {
  __typename?: 'ProjectIssuesCount';
...
export type Query = {
  ...
  projectIssuesCount: Array<ProjectIssuesCount>;
...
export type IssueFragmentFragment = { __typename?: 'Issue', id: string, issueNumber: string, summary: string, description?: string | null, type: IssueType, status: IssueStatus, storyPoints?: number | null, projectId: string, sprintId?: string | null, assigneeUserId?: string | null, orderIndex: number, reporterUserId: string, assignee?: (
    { __typename?: 'User' }
...
export type Project_Issues_CountQueryVariables = Exact<{ [key: string]: never; }>;


export type Project_Issues_CountQuery = { __typename?: 'Query', projectIssuesCount: Array<{ __typename?: 'ProjectIssuesCount', projectId: string, issuesCount: number }> };
...
export const Project_Issues_CountDocument = {"kind":"Document","definitions":[{"kind":"OperationDefinition","operation":"query","name":{"kind":"Name","value":"PROJECT_ISSUES_COUNT"},"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"projectIssuesCount"},"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"projectId"}},{"kind":"Field","name":{"kind":"Name","value":"issuesCount"}}]}}]}}]} as unknown as DocumentNode<Project_Issues_CountQuery, Project_Issues_CountQueryVariables>;
